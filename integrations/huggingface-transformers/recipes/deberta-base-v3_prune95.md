...
pruning_modifiers:
  - !GMPruningModifier
    params:
      - re:debertav2.encoder.layer.*.attention.self.query_proj.weight
      - re:debertav2.encoder.layer.*.attention.self.key_proj.weight
      - re:debertav2.encoder.layer.*.attention.self.value_proj.weight
      - re:debertav2.encoder.layer.*.attention.output.dense.weight
      - re:debertav2.encoder.layer.*.intermediate.dense.weight
      - re:debertav2.encoder.layer.*.output.dense.weight
...
python transformers/examples/pytorch/question-answering/run_qa.py \
  ...
  --save_steps 1000 \
  --save_total_limit 2 \
  --recipe ../recipes/deberta-base-v3_prune95.md \
